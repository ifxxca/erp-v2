...
P0 architecture baseline dan P1 Identity governance sudah disetujui. API, ERP Web, Operations Web, shared packages, local infrastructure, serta multi-company identity schema sudah di-scaffold. Lihat status verifikasi sebelum menganggap capability siap production.
